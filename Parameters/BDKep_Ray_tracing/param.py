...
class PARAMS(object):
    ...
    def __init__(self, config = {}):
        ...
        self.DEFAULTS = {
                ...
                'sigma_prior_T': 0,                 # sigma_prior = sqrt(1/weight_decay) Teacher
                'sigma_prior_S': 0,              # sigma_prior = sqrt(1/weight_decay) Student
                'lr_T': 1e-5,                                    # Learning rate Teacher
                'lr_S': 1e-4,                                    # Learning rate Student
                ...
                # TRAINING PARAMETERS
                'num_epochs' : 600,   # num_epochs = mix_epochs * N_samples_param + burnin_epochs + 1
