...
class PARAMS(object):
    ...
    def __init__(self, config = {}):
        ...
        self.DEFAULTS = {
                ...
                'BNN_algorithm':'BBP',
                'Phi_pdf_name':'Gaussian',
                'mean_Phi_pdf':0,
                'var_Phi_pdf':1,
                'N_samples_fitting': 10,          # Number of samples from the posterior (training)
                'N_samples_param':100,           # Number of samples from the posterior (validation)
