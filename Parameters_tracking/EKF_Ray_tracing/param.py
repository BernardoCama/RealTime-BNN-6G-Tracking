...
class PARAMS(object): 
    ...
    def __init__(self, config = {}):
        ...
        self.DEFAULTS = {
                ...
                # TRACKING ALGORITHM         
                'Tracking_algorithm':'EKF_Ray_tracing',

                # PREDICTION - MOTION MODEL
                'std_noise_position_motion_model': 1, # 0.5    # the std on the motion model is the real one + std_noise_position_motion_model
