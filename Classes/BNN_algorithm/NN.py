...
class NN(object):
    ...
    def __init__(self, params):
        ...
        self.__dict__.update(NN.DEFAULTS, **params_dict)

        self.params.BNN_algorithm_master = 'NN'
        self.BNN_algorithm_master = self.params.BNN_algorithm_master
        self.params.number_outputs_per_output_feature = 1 if self.params.bool_use_BNN == 0 else self.params.number_outputs_per_output_feature
    ...
    # Sample
    def sample(self, model, x, N_samples_param = 1000, epoch = None, batch_idx = None, output_additional_data = None, train = 0):
